        ...
        <div className="px-4 py-4 mx-auto sm:px-6 lg:px-8">
          <div className="">
            ...
            <div className="mt-16 sm:flex sm:justify-between sm:items-center">
              <div className="flex justify-center text-slate-50 hover:text-slate-50/75 hover:cursor-pointer sm:justify-start">
                <Link href ='/' legacyBehavior>
                <img src={'http://alexanders80.sg-host.com/wp-content/uploads/2023/03/icon.png'} className='h-40' />
                </Link>
              </div>
